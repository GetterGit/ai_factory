...
└── README.md                    # You're reading this (replace after planning)
```
...
| `README.md` | Phase 5 | **Replaces this file** with project-specific docs |

## After Your PoC Is Built

This template README gets replaced with your project's README containing:
